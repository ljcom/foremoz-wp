...
- [~] Foundation i18n untuk web/app admin dengan language pack `id` dan `en`.
  ...
  - Remark: provider i18n, switcher `ID/EN`, persistence local, dan translate awal untuk landing web + flow auth utama + browse/register event + dashboard/public passport + workspace shell (`/a/:account`, `dashboard`, `admin`) sudah masuk. Surface admin detail form dan page lain masih perlu dirapikan bertahap.
