...
const translations = {
  id: {
    ...
    'web.hero.title': 'Semua event, program, dan komunitas kamu dalam satu tempat.',
    ...
    'web.quickStart.joinClass': 'Ikut Program',
    ...
    'auth.memberSignIn.afterDescription': 'Portal member menampilkan event yang sudah kamu join, status subscription, PT balance, booking program, dan aktivitas payment.',
    ...
    'auth.memberSignup.unlockDescription': 'Setelah daftar, kamu langsung masuk ke portal member untuk lihat event yang diikuti, status membership, PT package, booking program, dan riwayat payment.',
  ...
  en: {
    ...
    'web.hero.eyebrow': 'Home',
    'web.hero.title': 'All your events, programs, and communities in one place.',
    ...
    'web.quickStart.joinClass': 'Join Program',
    ...
    'auth.memberSignIn.afterDescription': 'The member portal shows joined events, subscription status, PT balance, program bookings, and payment activity.',
    ...
    'auth.memberSignup.unlockDescription': 'After signing up, you go straight into the member portal to view joined events, membership status, PT packages, program bookings, and payment history.',
